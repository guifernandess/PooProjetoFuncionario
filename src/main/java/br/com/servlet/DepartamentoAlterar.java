 ...
 * @author Guilherme
 */
public class DepartamentoAlterar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            departamento.setIdDepartamento(Integer.parseInt(request.getParameter("id")));
            departamento.setNome(request.getParameter("nome"));

            DepartamentoController.alterar(departamento);
            request.getRequestDispatcher("./DepartamentoListar").forward(request, response);
